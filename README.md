...
|---|---|---|---|
| [1](labs/ch1-agent-basics/) | Agent basics | [1-1 Context ablation](labs/ch1-agent-basics/1-1-context/) · [1-2 Tools: who runs them, what they return](labs/ch1-agent-basics/1-2-who-runs-the-tool/) · [1-3 Code as a tool](labs/ch1-agent-basics/1-3-code-as-a-tool/) | ✅ 3 ready |
...
| [3](labs/ch3-memory/) | Memory & knowledge **(book's numbering)** | [3-1 User memory](labs/ch3-memory/3-1-user-memory/) · [3-3 Log sanitization](labs/ch3-memory/3-3-log-sanitization/) · [3-4 Dense retrieval](labs/ch3-memory/3-4-dense-embedding/) · [3-5 Retrieval from scratch](labs/ch3-memory/3-5-sparse-embedding/) | ⚠️ 4 of the book's 13 |
