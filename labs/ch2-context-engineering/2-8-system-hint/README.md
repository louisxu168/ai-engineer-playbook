# Lab 2-8: The agent status bar — let it glance, not recount
...
```bash
python3 agent.py all --weak      # needs Ollama; see lab 2-1
```
...
>
> Same trap as [lab 2-1](../2-1-local-llm-serving/README.md): **a controlled experiment run
...
| `--weak` errors out | Needs Ollama; see [lab 2-1](../2-1-local-llm-serving/README.md) |
