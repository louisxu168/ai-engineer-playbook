...
|---|---|---|---|
| [1](labs/ch1-agent-basics/) | Agent basics | [1-1 Context ablation](labs/ch1-agent-basics/1-1-context/) · [1-2 Tools decide what an agent can do](labs/ch1-agent-basics/1-2-who-runs-the-tool/) · [1-3 Code as a tool](labs/ch1-agent-basics/1-3-code-as-a-tool/) | ✅ 3 ready |
