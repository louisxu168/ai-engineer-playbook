...
| 章 | 主题 | 本章实验 | 状态 |
|---|---|---|---|
| [第 1 章](labs/ch1-agent-basics/README.zh-CN.md) | Agent 基础 | [1-1 上下文消融](labs/ch1-agent-basics/1-1-context/README.zh-CN.md) · [1-2 工具：谁来跑，返回什么](labs/ch1-agent-basics/1-2-who-runs-the-tool/README.zh-CN.md) · [1-3 代码即工具](labs/ch1-agent-basics/1-3-code-as-a-tool/README.zh-CN.md) | ✅ 3 个可用 |
...
| [第 3 章](labs/ch3-memory/README.zh-CN.md) | 记忆与知识 **（编号沿用原书）** | [3-1 用户记忆](labs/ch3-memory/3-1-user-memory/README.zh-CN.md) · [3-3 日志脱敏](labs/ch3-memory/3-3-log-sanitization/README.zh-CN.md) · [3-4 稠密向量检索](labs/ch3-memory/3-4-dense-embedding/README.zh-CN.md) · [3-5 从零写检索](labs/ch3-memory/3-5-sparse-embedding/README.zh-CN.md) | ⚠️ 原书 13 个项目，做了 4 个 |
