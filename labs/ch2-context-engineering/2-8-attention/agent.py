...
""",
  ...
  ★ 而行为层面的后果，在[实验 2-6](../2-6-status-bar/README.zh-CN.md)里量过了：
...
""",
  ...
  * The behavioural consequence was measured in [lab 2-6](../2-6-status-bar/README.md):
