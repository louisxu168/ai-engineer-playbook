# Lab 3-3: Log redaction — what should never enter the context
...
```bash
cd labs/ch3-memory/3-3-log-sanitization
...
## ⚠️ Hold on — doesn't this contradict lab 2-5?
...
| | Lab 2-5 injection defence | Lab 3-3 log redaction |
|---|---|---|
