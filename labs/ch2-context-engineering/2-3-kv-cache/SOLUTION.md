# Lab 2-3 answers: five context-management anti-patterns
...
## 3. ★ This lab solved lab 2-1's mystery

In [lab 2-1](../2-1-local-llm-serving/SOLUTION.md) I **failed to reproduce** cache invalidation
across several attempts and honestly wrote it up as "I couldn't do it".

**Here it reproduced on the first try. What's different?**

| | Lab 2-1 (failed) | Lab 2-3 (worked) |
|---|---|---|
...
### ★ Postscript: lab 2-1's "position effect" now reproduces

Lab 2-1 left one question open: **does it matter whether you change the start or the end of
...
> Hint: when does "who said it" matter? Recall lab 2-5's prompt injection — that entire
...
> **You just derived lab 2-9 (context compaction)'s motivation yourself.**
...
> Which is lab 2-5's conclusion echoing here:
